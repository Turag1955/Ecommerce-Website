...
if (isset($_POST['submit_product'])) {
    ...
    if (!$errors) {
        ...
        $sql = "INSERT INTO `product`( `category_id`,`added_id`,`sub_category`, `name`, `mrp`, `price`, `qty`, `image`, `short_dec`, `description`, `meta_title`, `meta_description`, `meta_keyword`, `status`) 
                                                        VALUES ('$category_id','$added_id','$sub_category','$name','$mrp','$price','$qty','$newimagename','$short_dec','$description','$meta_title','$meta_description','$meta_keyword','1')";
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <a  class=""href="product.php"> <div class="card-header"><strong>Product <i class="fa fa-arrow-circle-right"></i></strong> </div></a>
                    <div class="card-body card-block">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <select class="form-control"  name="category" id="sub_category" onchange="get_sub_category()" required="">
                                    <option value="">category</option>
                                    <?php
                                    $category_sql = mysqli_query($conn, "SELECT * FROM `category` where status = 1 ");
                                    while ($category_assoc = mysqli_fetch_assoc($category_sql)) {
                                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mrp" placeholder="Mrp" name="mrp" required="" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="short_dec" id="short_dec"  rows="2" required=""></textarea>
                            </div>
                            <div class="form-group">
